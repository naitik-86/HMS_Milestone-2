  ...
  <div>
    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <select
          multiple
          className="w-full h-40 border border-slate-300 p-3 rounded-2xl"
        >
          <option>CBC</option>
        ...
        <p className="text-xs text-slate-500 mt-2">
          Hold Ctrl to select multiple tests
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 mt-2">
          Hold Ctrl to select multiple samples
        </p>
      </div>
    ...
    <div className="mt-6">
      ...
      <input
        value="LAB-2026-001"
        readOnly
        className="w-full bg-slate-100 border border-slate-300 p-3 rounded-2xl"
      />
    ...
    <div className="mt-6 bg-blue-50 border border-blue-200 rounded-2xl p-5">
      ...
      <p className="text-sm text-slate-700">
        Selected tests will generate a laboratory order.
        Reports will be linked automatically with this case
        once uploaded by the laboratory team.
      </p>
