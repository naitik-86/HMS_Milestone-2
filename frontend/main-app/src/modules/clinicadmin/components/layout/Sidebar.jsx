...
const Sidebar = ({ isOpen = false, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 shrink-0 transform transition-transform duration-300 ease-out lg:sticky lg:top-0 lg:z-auto lg:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"
          }`}
        style={{
          width: 240,
          background: "#111827",
