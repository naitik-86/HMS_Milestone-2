...
export default function PendingPets() {
  ...
  const filteredPets = pets.filter((petItem) => {
    ...
    const token = String(petItem.tokenNumber || petItem.token || "");
                      ...
                      <tr key={petItem._id} className="hover:bg-[#D9E8E3]/15 transition-all duration-150">
                        ...
                        <td className="px-6 py-4 text-center">
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <button onClick={() => handleDelete(petItem)} className="grid size-9 place-items-center rounded-lg border border-rose-200 bg-rose-50 text-rose-600 transition hover:bg-rose-100" title="Delete visit"><Trash2 className="size-4" /></button>
                          </div>
                        </td>
                      </tr>
                    );
                ...
                return (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <button onClick={() => handleDelete(petItem)} className="bg-rose-50 text-rose-600 border border-rose-200 py-2 rounded-xl transition-all flex items-center justify-center" title="Delete visit"><Trash2 className="w-4 h-4" /></button>
                    </div>
                  </div>
                );
              })
