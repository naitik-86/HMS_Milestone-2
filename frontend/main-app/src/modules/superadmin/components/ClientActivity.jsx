    ...
    return (
        <div className="bg-white rounded-xl p-4 md:p-6 shadow-sm my-2 overflow-hidden">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-5">
                ...
                <button className="w-full sm:w-auto border border-gray-200 rounded-lg px-3 py-2 text-xs font-semibold text-gray-500 flex items-center justify-center gap-1">
                    View All Clients
                    <svg
                        className="w-3 h-3"
                        fill="none"
            ...
            {/* Tabs */}
            <div className="flex overflow-x-auto whitespace-nowrap border-b-2 border-gray-100 mb-4">
                {[
                    "Recent Clients",
                    "Order Activity",
                    "Client Engagement",
                    ...
                    <button
                        ...
                        className={`px-4 py-2 text-sm font-medium border-b-2 -mb-0.5 transition-all shrink-0
                        ${
                            activeTab === t
                    ...
                    <tbody>
                        {clients.map((c) => (
                            ...
                            >
                                ...
                                <td className="py-2.5 px-3">
                                    <button className="text-gray-300 hover:text-gray-500 text-lg px-1">
                                        ⋮
                                    </button>
                                </td>
                            </tr>
